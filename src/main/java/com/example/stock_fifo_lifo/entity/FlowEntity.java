...
public class FlowEntity {
    ...
    public void newOut(Connection connection, Timestamp outed, String id_item, double quantity, double unit_price, String id_store, String id_entry) throws Exception {
        String sql = null;
        ...
        sql = "INSERT INTO out(id, outed, id_item, quantity,unit_price, id_store, id_entry) VALUES (?, ?, ?, ?, ?, ?, ?)";
        try {
            ...
            preparedStatement.setString(7, id_entry);
    ...
    public Flow getPrice(Connection connection, String id_item, String id_store, Timestamp date, String type_name) throws Exception {
        ...
        if(type_name.equalsIgnoreCase("PUMP")){
            StockEntity stockEntity = new StockEntity();
            Stock stock = stockEntity.stockAvailableOnDate(connection, date, id_item, id_store);
            System.out.println(stock.getTotal() + " total " + stock.getInitial_quantity() + " initial ");
            price = stock.getTotal() / stock.getInitial_quantity();
        }
        if(type_name.equalsIgnoreCase("FIFO") || type_name.equalsIgnoreCase("PUMP"))
        ...
        try {
            ...
            if(type_name.equalsIgnoreCase("FIFO") || type_name.equalsIgnoreCase("LIFO"))
                return new Flow(id, null, null, null, null, null, quantity, unit_price, null, null);
            else
                return new Flow(id, null, null, null, null, null, quantity, price, null, null);
        }catch (Exception e){
            throw e;
        }
    }
    ...
    public String is_fifo_or_lifo(Connection connection, String id_item, String id_store, Timestamp date) throws Exception {
        System.out.println("tonga ato :" + date);
        String sql = null;
    ...
    public boolean out(Connection connection, String id_item, String id_store, Timestamp date, double quantity) throws Exception {
        ...
        try{
            ...
            while(break_loop) {
                ...
                System.out.println("Prix unitaire" + result.getUnit_price());
                if (result != null) {
                    ...
                    if (quantity_temp <= quant) {
                        ...
                        flowEntity.newOut(connection, date, id_item, quantity_temp, result.getUnit_price(), id_store, result.getId());
                    } else {
                        System.out.println("eto ndray");
                        flowEntity.reduce_out(connection, id_item, id_store, result.getId(), quant);
                        flowEntity.newOut(connection, date, id_item, quant, result.getUnit_price(), id_store, result.getId());
                        break_loop = false;
                    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        result = flowEntity.out(null, "IR00001", "ST00001", Timestamp.valueOf("2023-06-06 00:00:00"), 10);
    }
}
